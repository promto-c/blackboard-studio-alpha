...
const readBackgroundJobSource = (value: unknown): BackgroundJobSource | undefined => {
  ...
  const generationGroupId = readString(value.generationGroupId);
  ...
  const comfyRegionId = readString(value.comfyRegionId);
  ...
  if (generationGroupId) source.generationGroupId = generationGroupId;
  ...
  if (comfyRegionId) source.comfyRegionId = comfyRegionId;
