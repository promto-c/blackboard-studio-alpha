...
import { AnyNode, LiquidGlassNode, UniformUIType, AnyUniform } from '@blackboard/types';
...
const LiquidGlassAdjustments: React.FC<{ node: AnyNode }> = ({ node: anyNode }) => {
  ...
  const handleReset = (name: string) => () => {
    const defaultUniforms = parseUniformsFromGLSL(LIQUID_GLASS_SHADER);
