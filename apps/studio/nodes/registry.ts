...
nodeRegistry.set(NodeType.MASKED_MERGE, maskedMergeNode);
nodeRegistry.set(NodeType.EXTRACT_CHANNELS, extractChannelsNode);
nodeRegistry.set(NodeType.MERGE_CHANNELS, mergeChannelsNode);
nodeRegistry.set(NodeType.PREMULTIPLY, premultiplyNode);
nodeRegistry.set(NodeType.UNPREMULTIPLY, unpremultiplyNode);
...
nodeRegistry.set(NodeType.FEATURE_MATCH, featureMatchNode);
...
nodeRegistry.set(NodeType.MATTE_CONTROL, matteControlNode);
