...
export const warpNode: NodeDefinition = {
  ...
  viewportTools: [
    { id: 'add_pin', label: 'Add Pin', icon: Plus },
    { id: 'move_pin', label: 'Move Pin', icon: CursorArrow, hotkey: 'V' },
  ],
  ...
  ViewportOverlayComponent: WarpOverlay,
  toolHotkeys: {
    a: 'add_pin',
    v: 'move_pin',
  },
